			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="code_postal" title="${message(code: 'adresse.code_postal.label', default: 'Codepostal')}" />
					
						<g:sortableColumn property="nom" title="${message(code: 'adresse.nom.label', default: 'Nom')}" />
				...
				<g:each in="${adresseInstanceList}" status="i" var="adresseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${adresseInstance.id}">${fieldValue(bean: adresseInstance, field: "code_postal")}</g:link></td>
					
						<td>${fieldValue(bean: adresseInstance, field: "nom")}</td>
